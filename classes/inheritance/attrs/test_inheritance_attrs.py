...
from classes.inheritance.attrs import Attenuation, NumberOfFilaments, ConnectorTechSpec, CableTechSpec


class TestInheritanceConnectorAttrs(unittest.TestCase):
