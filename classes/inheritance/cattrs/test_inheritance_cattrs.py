...
from classes.inheritance.cattrs import Attenuation, NumberOfFilaments, ConnectorTechSpec, CableTechSpec
...
class TestInheritanceCableCattrs(unittest.TestCase):
